...
def task():
    ...
    next_execution_time = datetime.fromtimestamp(iterator.get_next())
    next_execution_time_2 = datetime.fromtimestamp(iterator.get_next())
    while True:
...
if __name__ == '__main__':
    ...
    if args.backup_format:
        config.backup_format = args.backup_format
